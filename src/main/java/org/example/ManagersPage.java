...
public class ManagersPage {
    ...
    ManagersPage(JFrame frame) {
        ...
        imgLabel.setBounds(230, 50, 500, 500);
        frame.add(imgLabel);

        JLabel label1 = new JLabel("MEAL EDITOR");
        label1.setBounds(650, 80, 350, 80);
        label1.setOpaque(true);
        label1.setBackground(Color.decode("#752A00"));
        label1.setForeground(Color.decode("#EF9B39"));
        label1.setFont(new Font("Arial", 1, 30));
        label1.setHorizontalAlignment(SwingConstants.CENTER);
        label1.setVerticalAlignment(SwingConstants.CENTER);
        label1.setBorder(new RoundedBorder(50, Color.decode("#551F01")));
        frame.add(label1);
        ...
        addMeal.setFont(new Font ("Arial", 0, 28));
        addMeal.setFocusable(false);
        addMeal.setBorder(new RoundedBorder(40, Color.decode("#331402")));
        ...
        editMeal.setFont(new Font ("Arial", 0, 28));
        editMeal.setFocusable(false);
        editMeal.setBorder(new RoundedBorder(40, Color.decode("#331402")));
        ...
        removeMeal.setFont(new Font ("Arial", 0, 28));
        removeMeal.setFocusable(false);
        removeMeal.setBorder(new RoundedBorder(40, Color.decode("#331402")));
    ...
    public void addMeal(JFrame frame) {
        ...
        JLabel label1 = new JLabel("ADD MEAL");
        label1.setBounds(500, 20, 350, 80);
        label1.setOpaque(true);
        label1.setBackground(Color.decode("#752A00"));
        label1.setForeground(Color.decode("#FACD97"));
        label1.setFont(new Font("Arial", 1, 30));
        label1.setHorizontalAlignment(SwingConstants.CENTER);
        label1.setVerticalAlignment(SwingConstants.CENTER);
        label1.setBorder(new RoundedBorder(50, Color.decode("#551F01")));
        ...
        mealNameLabel.setBounds(350, 140, 250, 30);
        ...
        mealNameTf.setBounds(350, 170, 300, 60);
        mealNameTf.setBorder(new RoundedBorder(20, Color.decode("#331402")));
        mealNameTf.setBackground(Color.white);
        frame.add(mealNameTf);

        //Add description Label
        descLabel.setText("Description");
        descLabel.setBounds(350, 250, 350, 30);
        descLabel.setForeground(Color.decode("#331402"));
        descLabel.setFont(new Font("Abadi MT Condensed Extra Bold", 0, 20));
        frame.add(descLabel);

        //Add description TextField
        descriptionTf.setBounds(350, 280, 300, 60);
        descriptionTf.setBorder(new RoundedBorder(20, Color.decode("#331402")));
...
//        categLabel.setForeground(Color.decode("#331402"));
...
//        lunchButton.setBorder(new RoundedBorder(20, Color.blue));
//        lunchButton.setBackground(Color.white);
//        lunchButton.setOpaque(false);
//        lunchButton.setFocusPainted(false);
//        lunchButton.setFocusable(false);
//        lunchButton.setUI(new javax.swing.plaf.basic.BasicButtonUI() {
//            @Override
//            public void paint(Graphics g, JComponent c) {
//                super.paint(g, c);
//                // Do nothing extra, preventing the default focus paint
//            }
//        });
...
//        dtLabel.setForeground(Color.decode("#331402"));
...
//        spiceLevel.setForeground(Color.decode("#331402"));
...
//        calsLabel.setForeground(Color.decode("#331402"));
